    ...
    <div class="main_menu">
        <nav class="navbar navbar-expand-lg navbar-light main_box">
            <div class="container">
                ...
                <a class="navbar-brand logo_h" href="/pembeli"
                    ><img
                        src="/assetuser/img/CEH.png"
                        alt=""
                        style="height: 55px"
                /></a>
                <button
                ...
                >
                    <ul class="nav navbar-nav menu_nav ml-auto mr-5">
                        <li
                            class="nav-item {{ (request()->is('pembeli')) ? 'active' : '' }}"
                        >
                        ...
                        <li
                            class="nav-item {{ (request()->is('kontak')) ? 'active' : '' }}"
                        >
...
>>>>>>> b173090ace3e3d492419389f481f63f7e45018bf
