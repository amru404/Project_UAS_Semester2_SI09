...
<<<<<<< HEAD
		<div class="main_menu">
			<nav class="navbar navbar-expand-lg navbar-dark bg-dark main_box" style="border-radius:5px; color:white">
				<div class="container">
					...
					<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
						<ul class="nav navbar-nav menu_nav ml-auto">
							<li class="nav-item  {{ (request()->is('pembeli')) ? 'active' : '' }}"><a class="nav-link" href="/pembeli">Home</a></li>
							<li class="nav-item  {{ (request()->is('kategori')) ? 'active' : '' }}"><a class="nav-link" href="{{ route('kategori') }}">Category</a></li>
							<li class="nav-item  {{ (request()->is('kontak')) ? 'active' : '' }}menu"><a class="nav-link" href="{{ route('kontak') }}">Contact</a></li>
						...
						<li class="nav-item submenu dropdown"><a href="{{ route('user.profile') }}" class="profile "><span class="bi bi-person-circle text-white"></span></a></li>
						</ul>
					</div>
				</div>
			</nav>
...
>>>>>>> 35a2a9e74e19bfdef50bd3adbef56994e454e952
